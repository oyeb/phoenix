...
[saber](http://www.github.com/arrow-/saber) shall be reborn as phoenix :wink: this year.
...
* Game **uses** `terra` to return latest Game state, scores and logs to Engine.

>Whatever be the Game, we can start work on the APIs and the Engine. Moreover we already know what are the responsibilities and function of the Engine.
